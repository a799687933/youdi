...
function(a) {
    ...
    var b = {
        init: function(c) {
            var d = this;
            return d.data("jqv") && null != d.data("jqv") || (c = b._saveOptions(d, c), a(document).on("click", ".formError",
            function() {
                a(this).fadeOut(150,
                function() {
        ...
        attach: function(c) {
            var e, d = this;
            return e = c ? b._saveOptions(d, c) : d.data("jqv"),
            e.validateAttribute = d.find("[data-validation-engine*=validate]").length ? "data-validation-engine": "class",
            e.binded && (d.on(e.validationEventTrigger, "[" + e.validateAttribute + "*=validate]:not([type=checkbox]):not([type=radio]):not(.datepicker)", b._onFieldEvent), d.on("click", "[" + e.validateAttribute + "*=validate][type=checkbox],[" + e.validateAttribute + "*=validate][type=radio]", b._onFieldEvent), d.on(e.validationEventTrigger, "[" + e.validateAttribute + "*=validate][class*=datepicker]", {
                delay: 300
            },
            b._onFieldEvent)),
            e.autoPositionUpdate && a(window).bind("resize", {
                noAnimation: !0,
                formElem: d
            },
            b.updatePromptsPosition),
            d.on("click", "a[data-validation-engine-skip], a[class*='validate-skip'], button[data-validation-engine-skip], button[class*='validate-skip'], input[data-validation-engine-skip], input[class*='validate-skip']", b._submitButtonClick),
            d.removeData("jqv_submitButton"),
            d.on("submit", b._onSubmitEvent),
            this
        },
        detach: function() {
            var c = this,
        ...
        updatePromptsPosition: function(c) {
            var d, e, f;
            return c && this == window ? (d = c.data.formElem, e = c.data.noAnimation) : d = a(this.closest("form, .validationEngineContainer")),
            f = d.data("jqv"),
            d.find("[" + f.validateAttribute + "*=validate]").not(":disabled").each(function() {
                var g, h, c = a(this);
        ...
        showPrompt: function(a, c, d, e) {
            ...
            g = f.data("jqv");
            return g || (g = b._saveOptions(this, g)),
        ...
        hide: function() {
            ...
            return f = a(this).is("form") || a(this).hasClass("validationEngineContainer") ? "parentForm" + b._getClassName(a(this).attr("id")) : b._getClassName(a(this).attr("id")) + "formError",
            a("." + f).fadeTo(e, .3,
            function() {
                a(this).parent(".formErrorOuter").remove(),
                a(this).remove()
        ...
        hideAll: function() {
            ...
            return a(".formError").fadeTo(d, 300,
            function() {
                a(this).parent(".formErrorOuter").remove(),
                a(this).remove()
            }),
        ...
        _onFieldEvent: function(c) {
            ...
            window.setTimeout(function() {
                ...
                0 == f.InvalidFields.length && f.onFieldSuccess ? f.onFieldSuccess() : f.InvalidFields.length > 0 && f.onFieldFailure && f.onFieldFailure()
            },
        ...
        _checkAjaxStatus: function(b) {
            var c = !0;
            return a.each(b.ajaxValidCache,
            function(a, b) {
        ...
        _validateFields: function(c) {
            ...
            if (c.trigger("jqv.form.validating"), f = null, c.find("[" + d.validateAttribute + "*=validate]").not(":disabled").each(function() {
                ...
                if (d.scroll) if (g = f.offset().top, h = f.offset().left, i = d.promptPosition, "string" == typeof i && -1 != i.indexOf(":") && (i = i.substring(0, i.indexOf(":"))), "bottomRight" != i && "bottomLeft" != i && (j = b._getPrompt(f), j && (g = j.offset().top)), d.scrollOffset && (g -= d.scrollOffset), d.isOverflown) {
                    if (k = a(d.overflownDIV), !k.length) return ! 1;
                    l = k.scrollTop(),
                    m = -parseInt(k.offset().top),
                    g += l + m - 5,
                    n = a(d.overflownDIV + ":not(:animated)"),
                    n.animate({
                        scrollTop: g
                    },
                    1100,
        ...
        _validateFormWithAjax: function(c, d) {
			...
			var mySubmit=$(c).find('input[type="submit"]'); 
			...
			var originalText=mySubmit.val(); //原提交(input 文字)
			var img=mySubmit.attr('img');
			var subTxt=mySubmit.attr('msg');
			var subLoad=img ? img : '';
			var subMsg=subTxt ? subTxt : '提交中...';
			if(subLoad) {
				mySubmit.css('background','#fff url('+subLoad+') no-repeat 50% center').css('border','#ccc;');
				mySubmit.val('');	
			}else{
				mySubmit.val(subMsg);			
			}			
            a.ajax({
                ...
                success: function(e) {
                    ...
                    if ("json" == h && e !== !0) {
						...
						if(e[0][1]==false){ //如果提交失败返回原来的按钮
							   if(originalText) mySubmit.val(originalText);
							   mySubmit.css('background',subBgColor);
							   mySubmit.attr('disabled',false);//放开提交按钮
						}else{
						      setTimeout(function(){
								   if(originalText) mySubmit.val(originalText);
								   mySubmit.css('background',subBgColor);
                        ...
                        for (f = !1, g = 0; g < e.length; g++) i = e[g],
                        j = i[0],
                        k = a(a("#" + j)[0]),
                        1 == k.length && (l = i[2], 1 == i[1] ? "" != l && l ? (d.allrules[l] && (m = d.allrules[l].alertTextOk, m && (l = m)), d.showPrompts && b._showPrompt(k, l, "pass", !1, d, !0)) : b._closePrompt(k) : (f |= !0, d.allrules[l] && (m = d.allrules[l].alertText, m && (l = m)), d.showPrompts && b._showPrompt(k, l, "", !1, d, !0)));
        ...
        _validateField: function(c, d, e) {
            ...
            for (h = g[1], i = h.split(/\[|,|\]/), j = !1, k = c.attr("name"), l = "", m = "", n = !1, o = !1, d.isError = !1, d.showArrow = !0, d.maxErrorsPerField > 0 && (o = !0), p = a(c.closest("form, .validationEngineContainer")), q = 0; q < i.length; q++) i[q] = i[q].replace(" ", ""),
            "" === i[q] && delete i[q];
            for (q = 0, r = 0; q < i.length; q++) {
                ...
                case "required":
                    n = !0,
                    t = b._getErrorMessage(p, c, i[q], i, q, d, b._required);
                    break;
                case "custom":
                    t = b._getErrorMessage(p, c, i[q], i, q, d, b._custom);
                    break;
                case "groupRequired":
                    u = "[" + d.validateAttribute + "*=" + i[q + 1] + "]",
                    v = p.find(u).eq(0),
                    v[0] != c[0] && (b._validateField(v, d, e), d.showArrow = !0),
                    t = b._getErrorMessage(p, c, i[q], i, q, d, b._groupRequired),
                    t && (n = !0),
                    d.showArrow = !1;
                    break;
                case "ajax":
                ...
                case "dateTimeRange":
                    ...
                    break;
                case "maxCheckbox":
                    c = a(p.find("input[name='" + k + "']")),
                    t = b._getErrorMessage(p, c, i[q], i, q, d, b._maxCheckbox);
                    break;
                case "minCheckbox":
                    c = a(p.find("input[name='" + k + "']")),
                    t = b._getErrorMessage(p, c, i[q], i, q, d, b._minCheckbox);
                    break;
                case "equals":
                ...
                case "creditCard":
                    ...
                    break;
                case "condRequired":
                    t = b._getErrorMessage(p, c, i[q], i, q, d, b._condRequired),
                    void 0 !== t && (n = !0)
                }
            ...
            return ! n && !c.val() && c.val().length < 1 && i.indexOf("equals") < 0 && (d.isError = !1),
            x = c.prop("type"),
            y = c.data("promptPosition") || d.promptPosition,
            ("radio" == x || "checkbox" == x) && p.find("input[name='" + k + "']").size() > 1 && (c = "inline" === y ? a(p.find("input[name='" + k + "'][type!=hidden]:last")) : a(p.find("input[name='" + k + "'][type!=hidden]:first")), d.showArrow = !1),
        ...
        _getErrorMessage: function(c, d, e, f, g, h, i) {
            ...
            return ("custom" === e || "funcCall" === e) && (k = f[j + 1], e = e + "[" + k + "]", delete f[j]),
            l = e,
            m = d.attr("data-validation-engine") ? d.attr("data-validation-engine") : d.attr("class"),
            n = m.split(" "),
            o = "future" == e || "past" == e || "maxCheckbox" == e || "minCheckbox" == e ? i(c, d, f, g, h) : i(d, f, g, h),
            void 0 != o && (p = b._getCustomErrorMessage(a(d), n, l, h), p && (o = p)),
            o
        },
        _getCustomErrorMessage: function(a, c, d, e) {
            ...
            else if (c.length > 0) for (i = 0; i < c.length && c.length > 0; i++) if (j = "." + c[i], "undefined" != typeof e.custom_error_messages[j] && "undefined" != typeof e.custom_error_messages[j][d]) {
        ...
        _custom: function(a, b, c, d) {
            var g, h, i, e = b[c + 1],
            f = d.allrules[e];
            if (!f) return alert("jqv:custom rule not found - " + e),
            void 0;
            if (f.regex) {
                if (h = f.regex, !h) return alert("jqv:custom regex not found - " + e),
                void 0;
                if (i = new RegExp(h), !i.test(a.val())) return d.allrules[e].alertText
            } else {
                if (!f.func) return alert("jqv:custom type not allowed " + e),
                void 0;
                if (g = f.func, "function" != typeof g) return alert("jqv:custom parameter 'function' is no function - " + e),
                void 0;
        ...
        _past: function(c, d, e, f, g) {
            ...
            return k = b._parseDate(d.val()),
            k > j ? (l = g.allrules.past, l.alertText2 ? l.alertText + b._dateToString(j) + l.alertText2: l.alertText + b._dateToString(j)) : void 0
        },
        _future: function(c, d, e, f, g) {
            ...
            return k = b._parseDate(d.val()),
            j > k ? (l = g.allrules.future, l.alertText2 ? l.alertText + b._dateToString(j) + l.alertText2: l.alertText + b._dateToString(j)) : void 0
        },
        _isDate: function(a) {
        ...
        _ajax: function(c, d, e, f) {
			...
			//2015-11-23 增加
			var cb=h.callBack ? h.callBack : ''; //回调函数
			//2015-11-23增加结束
            if ("object" == typeof i) a.extend(k, i);
            else if ("string" == typeof i) for (l = i.split("&"), e = 0; e < l.length; e++) m = l[e].split("="),
            m[0] && m[0] && (k[m[0]] = m[1]);
            if (j) for (o = String(j).split(","), e = 0; e < o.length; e++) p = o[e],
            a(p).length && (q = c.closest("form, .validationEngineContainer").find(p).val(), p.replace("#", "") + "=" + escape(q), k[p.replace("#", "")] = q);
            return "field" == f.eventTrigger && delete f.ajaxValidCache[c.attr("id")],
            f.isError || b._checkAjaxFieldStatus(c.attr("id"), f) ? void 0 : (a.ajax({
        ...
        _parseDate: function(a) {
            ...
            b == a ? (b = a.split("."), new Date(b[2], b[1] - 1, b[0])) : new Date(b[0], b[1] - 1, b[2])
        },
        _showPrompt: function(c, d, e, f, g, h) {
            ...
            h && (i = !1),
            a.trim(d) && (i ? b._updatePrompt(c, i, d, e, f, g) : b._buildPrompt(c, d, e, f, g))
        },
        _buildPrompt: function(c, d, e, f, g) {
            ...
            case "bottomLeft":
            case "bottomRight":
                h.find(".formErrorContent").before(k),
            ...
            return g.addPromptClass && h.addClass(g.addPromptClass),
            m = c.attr("data-required-class"),
            void 0 !== m ? h.addClass(m) : g.prettySelect && a("#" + c.attr("id")).next().is("select") && (n = a("#" + c.attr("id").substr(g.usePrefix.length).substring(g.useSuffix.length)).attr("data-required-class"), void 0 !== n && h.addClass(n)),
            h.css({
                opacity: 0
            }),
            "inline" === j ? (h.addClass("inline"), "undefined" != typeof c.attr("data-prompt-target") && a("#" + c.attr("data-prompt-target")).length > 0 ? h.appendTo(a("#" + c.attr("data-prompt-target"))) : c.after(h)) : c.before(h),
            l = b._calculatePosition(c, h, g),
            h.css({
            ...
            g.autoHidePrompt && setTimeout(function() {
                h.animate({
                    opacity: 0
                },
                function() {
        ...
        _saveOptions: function(b, c) {
            var d, e;
            return a.validationEngineLanguage ? d = a.validationEngineLanguage.allRules: a.error("jQuery.validationEngine rules are not loaded, plz add localization files to the page"),
            a.validationEngine.defaults.allrules = d,
            e = a.extend(!0, {},
            a.validationEngine.defaults, c),
            b.data("jqv", e),
            e
        },
