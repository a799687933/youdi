...
/*******calendar.js**********************************************************************************/
Calendar = function (mondayFirst, dateStr, onSelected, onClose,imgPath) {
    // member variables
    this.activeDiv = null;
    ...
    this.isPopup = true;
    this.weekNumbers = false;//true;//��Ҫ��ǰ������
...
Calendar.cellClick = function(el) {
    ...
    if (typeof el.navtype == "undefined") {
        ...
        cal.callCloseHandler();//����Ҳ���ùر�;added by jarry
    } else {
        if (el.navtype == 200) {
            Calendar.removeClass(el, "hilite");
...
//  (this.weekNumbers) && ++title_length;
    ...
    this._nav_py = hh("<img id=objyprev src=\""+this.imgPath+"/yprev.gif\">", 1, -2);
...
//  this._nav_py = hh("&#x00ab;", 1, -2);
    ...
    //  this._nav_ny = hh("&#x00bb;", 1, 2);
    this._nav_ny = hh("<img id=objynext src=\""+this.imgPath+"/ynext.gif\">", 1, 2);
    this._nav_ny.width = 25;
    this._nav_ny.ttip = Calendar._TT["NEXT_YEAR"];

//  this._nav_pm = hh("&#x2039;", 1, -1);
    this._nav_pm = hh("<img id=objmprev src=\""+this.imgPath+"/mprev.gif\">", 1, -1);
...
//  this._nav_nm = hh("&#x203a;", 1, 1);
    this._nav_nm = hh("<img id=objmnext src=\""+this.imgPath+"/mnext.gif\">", 1, 1);
...
//  this._nav_now.ttip = Calendar._TT["GO_TODAY"];
    ...
    if (this.isPopup) {
        ...
        //this.title.style.cursor = "move";//ע���ƶ�״̬
        //hh("&#x00d7;", 1, 200).ttip = Calendar._TT["CLOSE"];//ȥ���رշ���ͼƬ���;
        var td_close = hh("<img id=objclose src=\""+this.imgPath+"/close.gif\">", 1, 200);
        td_close.ttip = Calendar._TT["CLOSE"];
        td_close.align = "right";
        //hh("#<div><img src=\"/Calendar/calendar/close.gif\" onmousedown=\"return;\"></div>", 1, 200).ttip = Calendar._TT["CLOSE"];
    }   
...
function showCalendar(id,imgPath,format) {
  if(!arguments[1]) imgPath = 'Calendar';       
  if(!arguments[2]) format = 'y-mm-dd'; 
  ...
  if (calendar != null) {
    ...
    var cal = new Calendar(false, null, selected, closeHandler,imgPath);
