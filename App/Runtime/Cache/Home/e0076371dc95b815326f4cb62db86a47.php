...
<!--content begin-->
 <div class="lbt">
     <div class="wrap"><div class="lbtm fl">
          <h1>客服中心</h1>
          <p><?php echo isL(L('StefanoTwoDesigners'),'Domenico Dolce和Stefano Gabbana两位设计师在意大利时尚圈扮演了举足轻重的角色。感性，妩媚的意大利时尚女性激起了两人的创作灵感，他们的设计风格性感中带干练，难怪在短短的30年内便能成功地将该品牌晋升为家喻户晓的奢侈品大牌。Farfetch现在就带你体验！');?>
             </p>
 ...
 <?php if(is_mobile()): ?><div class="cjl">
  ...
  <div class="cjr" id="rhgw">
  <h1><?php echo ($result['titletext']); ?></h1>
    <ul>
   	<li>
     <p class="lh40 pt15" style="min-height:500px;"><?php echo (stripcslashes($result['content'])); ?></p>
    </li>
   </ul>    
  </div><!--cjwtr end-->
  <div class="cb"></div>
