...
<div class="lbt">
     <div class="wrap"><div class="lbtm fl">
          ...
          <P style="height:44px;"> <?php echo isL(L('StefanoTwoDesigners'),'Domenico Dolce和Stefano Gabbana两位设计师在意大利时尚圈扮演了举足轻重的角色。感性，妩媚的意大利时尚女性激起了两人的创作灵感，他们的设计风格性感中带干练，难怪在短短的30年内便能成功地将该品牌晋升为家喻户晓的奢侈品大牌。YOUDI WU现在就带你体验！');?></P>
     </div><div class="cb"></div></div>
 </div>
 <!--<h1 class="title"><div class="wrap"><span><?php echo ($result['titletext']); ?></span></div></h1>-->
 <div class="wrap"><div class="gywm mt20">
  <img src="__ROOT__/<?php echo ($result['thumb']); ?>" alt=""/>
  <div class="gywmr">
   <p><?php echo (stripcslashes($result['content'])); ?></p>
  </div>
  <div class="cb"></div>
 </div></div>
 <!--<div class="app">
     <div class="gywm mt20">
         <div class="gywmm"><?php echo (stripcslashes($result['content'])); ?></div> 
     </div>
