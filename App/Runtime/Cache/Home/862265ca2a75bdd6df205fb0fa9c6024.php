...
<div class="lbt">
 ...
 <!--
  ...
  <div class="cjr" id="ysyzc">
  <h1><?php echo ($result['titletext']); ?></h1>
   <ul>
   	<li>
     <p class="p20 f13 lh28"><?php echo (stripcslashes($result['content'])); ?></p>
    </li>
    
   </ul>
   <div class="pv20 tl"><span class="fhdb"><span class="icon19"><span class="glyphs icon-arrowUp" style="line-height:30px;"></span></span><span class="pl10"><?php echo isL(L('ReturnToTheTop'),'返回顶部');?></span></span></div>
  </div><!--cjwtr end-->
  <div class="cb"></div>
 </div><!--cjwt end-->
