...
<title><?php echo isL(L('News'),'YOUDI WU最新资讯');?></title>
...
<div class="banner"><span class="bannerl"></span><span class="bannerr"></span>
 <div class="swiper-wrapper">
  <?php if(is_array($newAd)): foreach($newAd as $key=>$a): ?><div class="swiper-slide"><a <?php if(trim($a['ad_url'])): ?>href="<?php echo ($a['ad_url']); ?>" target="_blank"<?php endif; ?>>
    <img src="__ROOT__/<?php echo ($a['ad_img']); ?>" />
  </a></div><?php endforeach; endif; ?>
 </div>
  <!--<ul class="bxslider">
      <?php if(is_array($newAd)): foreach($newAd as $key=>$a): ?><li>
              <a <?php if(trim($a['ad_url'])): ?>href="<?php echo ($a['ad_url']); ?>" target="_blank"<?php endif; ?>>
                   <img src="__ROOT__/<?php echo ($a['ad_img']); ?>" />
              </a>
          </li><?php endforeach; endif; ?>
	</ul> -->
...
<div class="cb"></div>
<?php if(!$_GET['babel'] and !$_GET['order_field']): ?><div class="wrap phoneno">
        <div class="flexslider" >
              <ul class="slides">
                 <?php if(is_array($newAd)): foreach($newAd as $adk=>$a): ?><li><b> <?php echo ($adk+1); ?> of <?php echo count($newAd);?> </b>
                        <table width="100%" height="100%">
                          <tr>
                              <td align="center" valign="middle" width="100%" height="100%">
                                  <a <?php if(trim($a['ad_url'])): ?>href="<?php echo ($a['ad_url']); ?>" target="_blank"<?php endif; ?>>
...
<?php else: ?> 
    <?php if($_GET['babel']): $YOU_LABEL=C('YOU_LABEL'); ?>
         <div class="zxzx">
             <div class="zxzxl">
                  <div class="zxtop">
                   <span class="zxtopicon mr15"></span><span style="font-size:30px;"><?php echo ($YOU_LABEL[$_GET['babel']]['cn_name']); ?></span><!--<img src="__HOME__/images/logo.png" width="128" alt="" class="vam"/>-->
                   <p><?php echo ($YOU_LABEL[$_GET['babel']]['cn_desc']); ?></p>
                  </div>
             </div>
             <div class="cb"></div>
         </div><!--标签新闻列表页的--><?php endif; endif; ?>

<div class="zxzx">
 <div class="zxzxl">
 <div class="zxbq">
  <a href="<?php echo U('Article/index',array('order_field'=>'addtime','order_type'=>$orders));?>" class="<?php echo ($_GET['order_field'] == 'addtime' && !$_GET['babel'] ? 'now' : ''); ?>">new</a>
  <a href="<?php echo U('Article/index',array('order_field'=>'count_click','order_type'=>$orders));?>" class="<?php echo ($_GET['order_field'] == 'count_click' ? 'now' : ''); ?>">hot</a>
  <a href="<?php echo U('Article/index',array('order_field'=>'addtime','order_type'=>$orders,'babel'=>1));?>" class="<?php echo ($_GET['babel'] == 1 ? 'now' : ''); ?>">youdi wu</a>
 </div>
 <script>
  $(function(){
...
<div class="zxzxl">
 ...
 <div class="zxlb">
  <ul id="add-end">
    <?php if(is_array($result)): foreach($result as $key=>$res): ?><li>
         <div class="zxlbli">
          <div class="zxlblil">
...
<div class="cb"></div>
 ...
 <?php if($pageNumShown > 1): ?><a href="javascript:void(0)" class="more mt45">
         <input type="button" onClick="mobile.clickPage(this,<?php echo ($pageNumShown); ?>,'#add-end','<?php echo U('Article/index','','');?>/p/');"
...
<div class="zximg">
 <ul>
    <?php if(is_array($general)): foreach($general as $key=>$res): ?><li>
         <div class="zximgt">
             <table width="100%" height="100%">
                 <tr>
                     <td align="center" valign="middle" width="100%" height="100%">
                         <a href="<?php echo U('Article/content',array('html'=>$res['id']));?>"><img src="__ROOT__/<?php echo ($res['thumb']); ?>" alt=""/></a>
                     </td>
                 </tr>
              </table>
         </div>
         <div class="zximgb">
          <p class="f12"><?php echo date('Y.m.d',$res['addtime']);?></p>
          <p><?php echo (sub_str(strip_tags($res['titletext']),15)); ?></p>
...
<!--<div class="zxb">
 ...
 <?php if($pageNumShown > 1): ?><div class="more mv10">
         <input type="button" onclick="mobile.clickPage(this,<?php echo ($pageNumShown); ?>,'#add-end','<?php echo U('Article/index','','');?>/p/');"
