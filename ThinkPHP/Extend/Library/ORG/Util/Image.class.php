...
class Image {
    ...
    static public function water($source, $water, $savename=null, $alpha=80) {
        ...
        //生成混合图像
       // imagecopymerge($sImage, $wImage, $posX, $posY, 0, 0, $wInfo['width'], $wInfo['height'], $alpha);//原代码不支持png图透明
        imagecopy($sImage, $wImage, $posX, $posY, 0, 0, $wInfo['width'], $wInfo['height']);//2014-4-5日修改
        //输出图像
